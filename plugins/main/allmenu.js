...
const pluginConfig = {
  ...
  category: "main",
  description: "Muestra todos los comandos completos por categoria",
  usage: ".allmenu",
  example: ".allmenu",
  isOwner: false,
  isPremium: false,
...
`;
  ...
  txt += `_© ${botConfig.bot?.name || "Nino AI"} | ${new Date().getFullYear()}_\n`;
      ...
      case 3: {
        ...
        await sock.sendMessage(
          m.chat,
          {
            ...
            fileName: `${toSmallCaps(botConfig.bot?.name || "Nino AI")} — ᴀʟʟ ᴍᴇɴᴜ`,
            caption: txt,
        ...
        const buttons = [
          {
            ...
            buttonParamsJson: JSON.stringify({
              ...
              sections: [{ title: "📋 ELIGE CATEGORIA", rows: categoryRows }],
            }),
          },
          {
            name: "quick_reply",
