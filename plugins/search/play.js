...
const pluginConfig = {
  ...
  alias: ["playaudio"],
  category: "search",
  description: "Reproducir música desde YouTube (Siputzx API)",
  usage: ".play <query>",
  example: ".play komang",
  cooldown: 15,
  energi: 1,
...
async function handler(m, { sock, text }) {
  ...
  try {
    ...
    m.react("😭");
    m.reply(
      `La función para reproducir música tiene problemas. Intenta de nuevo más tarde y evita hacer spam.`,
    );
  }
}
