...
const pluginConfig = {
  ...
  category: "rpg",
  description: "Jual beli item a NPC merchant",
...
const SHOP_ITEMS = {
  potion: { name: "🧪 Potion", buyPrice: 100, sellPrice: 50, desc: "Restaura 50 HP" },
  manapotion: { name: "💙 Pocion de Mana", buyPrice: 150, sellPrice: 75, desc: "Restaura 50 Mana" },
  antidote: { name: "💊 Antidoto", buyPrice: 80, sellPrice: 40, desc: "Cura el veneno" },
  bread: { name: "🍞 Roti", buyPrice: 30, sellPrice: 15, desc: "Restaura 10 stamina" },
  energydrink: { name: "⚡ Energy Drink", buyPrice: 200, sellPrice: 100, desc: "Restaura 50 stamina" },
  pickaxe: { name: "⛏️ Beliung", buyPrice: 500, sellPrice: 250, desc: "Untuk mestong" },
  ...
  iron: { name: "🔩 Besi", buyPrice: 80, sellPrice: 40, desc: "Material lonom" },
  ...
  herb: { name: "🌿 Herba", buyPrice: 70, sellPrice: 35, desc: "Materiales alchemy" },
...
\n` +
  ...
  if (action === "sell") {
    ...
    const item = SHOP_ITEMS[itemKey];
    if (!item) {
      return m.reply(`❌ Item no puede enjual a merchant!`);
    }
