...
const pluginConfig = {
    ...
    category: 'owner',
    description: 'Agregar exp al usuario (max. 9 mil millones)',
...
async function handler(m, { sock }) {
    ...
    if (amount <= 0) {
        return m.reply(`❌ *ꜰᴀʟʟᴏ*\n\n> La cantidad de exp debe ser mayor que 0`)
    }
    ...
    await m.reply(
        `✅ Exp agregada correctamente *${formatNumber(amount)}* ke *@${targetJid.split('@')[0]}*`,
        { mentions: [targetJid] }
    )
}
