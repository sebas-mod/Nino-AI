...
const pluginConfig = {
    ...
    category: 'owner',
    description: 'Cambiar audio ourin.mp3',
    usage: '.ganti-ourin.mp3 (responde/envia audio)',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        if (!buffer) {
            return m.reply(`❌ Fallo: mendownload audio`)
        }
        ...
        m.reply(`✅ *ʙᴇʀʜᴀsɪʟ*\n\n> Audio ourin.mp3 fue reemplazado`)
