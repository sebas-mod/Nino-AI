...
const pluginConfig = {
    ...
    category: 'owner',
    description: 'Actualizar script automaticamente desde GitHub con copia de datos importantes',
    usage: '.updatescript',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        if (!hasGit) {
            return m.reply(
                `❌ *ꜰᴀʟʟᴏ*\n\n` +
                `> Git no esta instalado en el servidor\n` +
        ...
        try {
            ...
            await m.reply(`✅ *ɴᴘᴍ ɪɴsᴛᴀʟʟ ᴄᴏʀʀᴇᴄᴛᴏ*`)
        } catch (e) {
            await m.reply(
                `⚠️ *ɴᴘᴍ ɪɴsᴛᴀʟʟ ꜰᴀʟʟᴏ*\n\n` +
