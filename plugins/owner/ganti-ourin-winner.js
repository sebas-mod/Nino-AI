...
const pluginConfig = {
    ...
    category: 'owner',
    description: 'Cambiar imagen ourin-winner.jpg (thumbnail game winner)',
    usage: '.ganti-ourin-winner.jpg (responde/envia imagen)',
...
async function handler(m, { sock }) {
    ...
    try {
        ...
        m.reply(`✅ *ʙᴇʀʜᴀsɪʟ*\n\n> Imagen ourin-winner.jpg fue reemplazado`)
